...
private slots:
    ...
    QString BuyCBP(QString OrderType, double Quantity, double Rate);
    QString SellCBP(QString OrderType, double Quantity, double Rate);
